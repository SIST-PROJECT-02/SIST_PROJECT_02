...
<script type="text/javascript">
	$(function() {
		$('#pwd2')
				.keyup(
						function() { // 유저가 뭔가 입력후 바로 체크 ==> keyup으로 체크 
							var k = $(this).val();
							console.log(k);
							var no = $('#no').val();
							$
									.ajax({
										type : 'POST',
										url : '../main/fpassword_check.do',
										data : {
											"pwd" : k,
											"no" : no
										}, // 요청과 함께 서버에 보내는 string 또는 json
	...
	<div class="wrapper row2">
		<div id="services" class="clear">
			...
			<img src="../../board/images/free.png" style="text-align:center;width:100%; height:120px;"/></div>
				<div id="update">
					<form method=post action="fupdate_ok.do">
						<table class="table table-hover"
							...
							<tr>
								...
								<td width=80%><textarea rows="8" cols="50" name="content"
										required>${vo.content }</textarea> <!-- input은 value로 주고, textarea는 태그 사이에 값 준다. -->
								</td>
							</tr>
							<tr>
