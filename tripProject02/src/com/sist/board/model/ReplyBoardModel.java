...
public class ReplyBoardModel {
	...
	// [리스트] 
	@RequestMapping("views/board/reply/list.do")
	public String reply_list(HttpServletRequest request, HttpServletResponse response)
	{
		...
		return "../../template/main/index.jsp";
	}
	
	
	
	// [상세페이지] 
	@RequestMapping("views/board/reply/detail.do")
	...
	// [새 글 작성]
	@RequestMapping("views/board/reply/insert.do")
	...
	// [새 글 작성] 
	@RequestMapping("views/board/reply/insert_ok.do")
	public String reply_insert_ok(HttpServletRequest request, HttpServletResponse response)
	{
		...
		return "redirect:../../board/reply/list.do";
	}
	
	// [글 수정] - 기존 글의 데이터 가져옴 
	@RequestMapping("views/board/reply/update.do")
	...
	// [글 수정] - 비번 체크 
	@RequestMapping("views/board/reply/password_check.do")
	...
	// [글 수정] - 실제 수정. update.
	@RequestMapping("views/board/reply/update_ok.do")
	public String reply_update_ok(HttpServletRequest request, HttpServletResponse response)
	{
		...
		return "redirect:../../board/reply/detail.do?no="+no;
	}
	
	@RequestMapping("views/board/reply/reply.do")
	...
	@RequestMapping("views/board/reply/reply_ok.do")
	public String reply_ok(HttpServletRequest request, HttpServletResponse response){
		...
		//.do = method 호출
		return "redirect:../../board/reply/list.do";      //reply_jsp() 를 다시 실행해서 데이터 요청하는 코딩실행
	}
	
	@RequestMapping("views/board/reply/delete.do")
	...
	@RequestMapping("views/board/reply/delete_ok.do")
